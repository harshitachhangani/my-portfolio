    ...
    <section className='min-h-[85vh] mt-32 lg:min-h-[78vh] flex items-center justify-center' id='home'>
      <div className='flex flex-col-reverse lg:flex-row lg:items-center md:justify-center lg:gap-x-12 '>
        ...
        <div className='flex max-w-screen-md mx-auto flex-col flex-1 md:items-start md:justify-start text-center lg:text-left  md:w-3/4 '>
          <h1 className=' text-[25px] font-bold font-main leading-[1.2] lg:text-[40px]'>
            Harshita <span>Chhangani </span>
          </h1>
          <div className='mb-6 text-[25px] lg:text-[55px] font-bold uppercase leading-[-1]'>
          ...
          <div className='flex items-center justify-center w-full md:justify-start gap-4 mt-4 '>
            ...
            <a href="https://drive.google.com/file/d/1eriHDj3STUA5nnAfu41Nk3SyGraTapNP/view?usp=sharing" target="_blank" rel="noopener noreferrer" className='text-gradient font-bold no-underline '>View Resume</a>
          </div>

          <div className='flex items-center justify-center w-full md:justify-start gap-4 mt-4 '>
            <a href="https://github.com/harshitachhangani" target="_blank" rel="noopener noreferrer">
              <FaGithub className='text-black text-2xl hover:text-gray-600' />
            </a>
            <a href="https://www.linkedin.com/in/harshita-chhangani-a82732257/" target="_blank" rel="noopener noreferrer">
        ...
        <div className='flex items-center justify-center py-8'>
          <img className='rounded-full w-64 h-64 object-cover shadow-2xl' src={pic} alt="My Image" />
        </div>
      </div>
